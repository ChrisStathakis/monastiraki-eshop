# Generated by Django 3.0.1 on 2020-04-29 06:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eng_title', models.CharField(blank=True, max_length=250, null=True, verbose_name='Τιτλος για την Αγγλικη Εκδοση')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eng_title', models.CharField(max_length=120, null=True, verbose_name='Τιτλος στα Αγγλικα')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eng_title', models.CharField(blank=True, max_length=120, null=True, verbose_name='Τιτλος στη Αγγλικη Εκδοση')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eng_title', models.CharField(max_length=250, null=True, verbose_name='Τιτλος για την Αγγλικη Εκδοση')),
            ],
            options={
                'ordering': ['title'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eng_title', models.CharField(blank=True, max_length=150, null=True, verbose_name='Τιτλος για την Αγγλικη Εκδοση')),
                ('eng_site_text', tinymce.models.HTMLField(blank=True, null=True, verbose_name='Κειμενο για την Αγγλικη Εκδοση')),
