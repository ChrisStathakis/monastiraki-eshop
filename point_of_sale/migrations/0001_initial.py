    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_expired', models.DateField(default=datetime.date(2020, 5, 2), verbose_name='Ημερομηνία')),
                ...
                ('order_type', models.CharField(choices=[('r', 'Λιανική Πώληση'), ('e', 'Πώληση Eshop'), ('b', 'Παραστατικό Επιστροφής'), ('c', 'Ακυρωμένη Παραγγελία'), ('wa', 'Παραστατικό Εισαγωγής'), ('wr', 'Παραστατικό Εξαγωγής')], default='r', max_length=2, verbose_name='Είδος')),
